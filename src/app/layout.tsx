...
export const metadata: Metadata = {
  ...
  description:
    'MagnaChip Semiconductor delivers innovative power solutions including MOSFETs, IGBTs, SiC devices, and Power ICs for automotive, industrial, and consumer applications.',
