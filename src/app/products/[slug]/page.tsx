          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="flex-1 min-w-0 text-center pt-10">
                ...
                <Link href="/products" className="text-sm text-gray-600 hover:text-black underline">Back to products</Link>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="flex-1 min-w-0">
              <FadeIn>
                <div className="max-w-2xl mb-10">
                  <p className="text-sm font-medium tracking-[0.2em] uppercase text-black mb-3">{category}</p>
                  <h1 className="text-3xl md:text-4xl font-bold text-gray-900 text-balance mb-4">{family}</h1>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Overview of the {family} product family. Select a voltage variant from the sidebar
                    to view detailed specifications and available products.
                  </p>
                </div>
              </FadeIn>
              ...
              {variants.length > 0 && (
                <FadeIn delay={0.1}>
                  <h2 className="text-sm font-semibold text-gray-700 mb-3">Available Voltage Variants</h2>
